                                ...
                                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                    <li class="nav-item dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                            <li><a class="dropdown-item" href="{{ route('user.profile') }}">Mon
                                                    profile</a></li>
                                            <li>
            ...
            <div class="card-body px-0">
                ...
                <div class="d-flex align-items-center justify-content-between px-4">
                    <div class="d-flex align-items-center">
                        ...
                        <img style="height: 35px" src="{{asset('/annonce/'. $annonce->image)}}" alt="">
                        <div class="ms-4">
                            <div class="small">{{ $annonce->prix }} $</div>
                            <div class="text-xs text-muted">{{ $annonce->titre }}</div>
                        </div>
                    </div>
                    <div class="ms-4 small">
                        @if($annonce->Dureelocation==1)
                        <div class="badge bg-light text-dark me-3">Monthly</div>
                        @else
                        <div class="badge bg-light text-dark me-3">Years</div>
                        @endif

                        <a class="text-danger" data-bs-toggle="modal" data-bs-target="#deleteUser{{ $annonce->id }}" href="#!">Supprimé</a>
                        <a href="#!" data-bs-toggle="modal" data-bs-target="#updateUser{{ $annonce->id }}">Modifier</a>
                    </div>
                    <!-- Button trigger modal -->

                </div>
                @include('partials.popup.UpdateAnnonces',['annonceId'=> $annonce->id])
                @include('partials.popup.deleteAnnonces',['annonceId'=> $annonce->id, 'annonce'=>$annonce])
                @endforeach
            </div>
        </div>
        <!-- Billing history card-->
        <div class="card mb-4">
            <div class="card-header">Listes de mes annonces</div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 text-center text-md-end">
                        <p class="mb-0 text-white"> &copy;Copyright <span id="copyright">
                            ...
                            </span> <a href="#"> Real villa </a> All Rights Reserved </p>
                    </div>
                </div>
            </div>
        </div>
