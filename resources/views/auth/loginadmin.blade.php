 ...
 header -->
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header bg-primary text-white"><h5 class="text-white text-center">{{ __('Login Admin') }}</h5></div>
    
                    <div class="card-body">
                        <div class="modal-body">
                            <form class="row my-4 align-items-center" method="POST" action="{{ route('admin.login') }}">
                                @csrf
    ...
    <!--=================================
footer-->
    <footer class="footer bg-dark space-pt mt-lg-5">
        <div class="container">
            <div class="row">
