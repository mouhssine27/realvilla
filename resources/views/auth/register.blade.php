            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="modal-body">
                        <form class="row my-4 align-items-center" method="POST" action="{{ route('register') }}">
                            @csrf
                            ...
                            <div class="mb-3 col-sm-12">
                                <input id="password-confirm" placeholder=" confirme-password" type="password"
                            ...
                            <div class="col-sm-6">
                                <ul class="list-unstyled d-flex mb-1 mt-sm-0 mt-3">
                                    <li class="me-1"><a href="{{ route('login') }}"><b>Already Registered User? Click
                                                here to
                                                login</b></a>
                                    </li>
                                </ul>
